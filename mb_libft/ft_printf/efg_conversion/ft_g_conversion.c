...
/*   Updated: 2022/05/19 14:46:54 by wdonnell         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_print_g_as_f(char **result, t_printer *args)
{
	char	*new_result;
	int		i;
	int		g;
...
static void	ft_change_format_to_g(char **result, t_printer *args)
{
	int		i;
	int		g;
